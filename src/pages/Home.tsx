  ...
  return (
    <main>
      ...
      <section className="mx-auto max-w-5xl px-4 py-16">
        <h1 className="text-3xl font-semibold text-slate-900 sm:text-4xl">Tijn van der Pol</h1>
        ...
        <Link
          to="/projecten"
          className="mt-6 inline-block rounded-md border border-slate-900 px-4 py-2 text-sm font-medium text-slate-900 transition-colors hover:bg-slate-900 hover:text-white"
        >
